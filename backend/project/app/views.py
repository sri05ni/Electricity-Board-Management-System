...
def uploaddata(request):
   try:
    ...
    #    for index,row in df.iterrows(): 
              ...
              print("Applicant:", row['Applicant_Name'])
    #  #get each row from csv file
              #create or update don't duplicate
              applicant,created=Applicant.objects.get_or_create(
      
                  #model.py_name =row['excel_name']
            ...
            #   print("Application date processed")
            ...
            #   print("Approval date processed:", Date_of_Approval)
            ...
            return HttpResponse("File data is not uploaded")

   return HttpResponse("file data is uploaded")
...
class ConnectionListView(ListView):
    ...
    #  paginate_by=100
     ...
     def get_queryset(self):
        ...
        queryset = super().get_queryset().select_related('Applicant', 'Status').order_by('id')
        ...
        # Parse date range parameters if provided (converting text/string to actual date data type)
